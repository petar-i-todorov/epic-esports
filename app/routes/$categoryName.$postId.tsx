	...
	return (
		<div className="ml-[16.67%] mr-[40%] flex flex-col gap-7 dark:text-white">
			...
			<div>
				...
				{format(parseISO(post.createdAt), 'MMMM d, yyyy h:mm a').toUpperCase()}
			</div>
			<div className="flex gap-2 items-center">
				...
				<Link to="." onClick={() => navigator.clipboard.writeText(currentUrl)}>
						...
						<Form key={emoji} method="post">
							<button className="flex flex-col gap-1 items-center text-4xl bg-white">
								...
								<span className="text-base">
									{reactions.find(reaction => reaction.name === emoji)?.count ??
										0}
								</span>
